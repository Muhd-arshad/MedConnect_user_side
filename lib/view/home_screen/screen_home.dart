...
import 'package:user_side_flutter/view/widgets/loading_screen_widget.dart';
...
class ScreenHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final listDocbasedonDpt =
        context.read<DoctorListingBasedonDepartmentProvider>();
                      ...
                      SizedBox(
                        ...
                        child: Consumer<DepartmentProvider>(
                          ...
                          return ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                return GestureDetector(
                                  onTap: () async {
                                    ...
                                    listDocbasedonDpt
                                        .getDoctorsForSelectedDepartment(
                                            context);
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) =>
                                            const ScreenDepartmentSub(),
                                      ),
                                    );
                                  },
                                  child: Container(
                                    ...
                                    child: Center(
                                        child: TextWidget(
                                      text: dptProvider.departmentmodel!
                              ...
                              itemCount: dptProvider
                                  .departmentmodel!.departments.length);
                        }),
                      ),
                      height20,
                      Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () async {
                              loadingProvider.setLoading(true);
                              await Provider.of<DoctorDetailsProvider>(context,
                                      listen: false)
                                  .fechDoctorDetails();
                        ...
                        child: Consumer<DoctorDetailsProvider>(
                          ...
                          return ListView.separated(
                              ...
                              itemCount: doctorDetailsProvider
                                  .listDoctorModel!.doctors.length);
                        }),
                      )
                    ],
                  ),
